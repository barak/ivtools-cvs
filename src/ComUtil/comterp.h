...
#define TOK_LANGBRACK2  24      /* left angle bracket (less than) */
#define TOK_RANGBRACK2  25      /* right angle bracket (greater than) */
#define TOK_KEYWORD     26      /* Keyword for free format parameters */

/* Token types returned from OPTABLE.C */
#define TOK_COMMAND     27      /* Command name */

#define TOK_BLANK       28      /* generated by empty parens: () */
