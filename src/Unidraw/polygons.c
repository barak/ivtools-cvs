...
void Rect::SetOriginal (Coord x0, Coord y0, Coord x1, Coord y1) {
    _x0 = x0;
    _y0 = y0;
    _x1 = x1;
    _y1 = y1;
...
ClassId SF_Rect::CompId () { return RECT_COMP; }
...
Graphic* S_Polygon::Copy () { return new S_Polygon(x(), y(), count(), this); }
...
Graphic* F_Polygon::Copy () { return new F_Polygon(x(), y(), count(), this); }
...
Graphic* SF_Polygon::Copy () { return new SF_Polygon(x(), y(), count(), this); }
ClassId SF_Polygon::CompId () { return POLYGON_COMP; }
